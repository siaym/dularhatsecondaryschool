...
export function Footer() {
  ...
  return (
    <footer className="bg-[#016B00] text-white mt-16">
      ...
      {/* Bottom Bar */}
      <div className="bg-[#024D00] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-green-300">
          ...
          <div className="text-center md:text-right">
            <p className="text-green-400 font-medium">
              {language === "bn"
                ? "ডেভেলপ করেছেন: মো. সাইফুল ইসলাম সিয়াম (প্রাক্তন ছাত্র)"
                : "Developed by: Md Syful Islam Siyam (Alumni)"}
            </p>
          </div>
        </div>
      </div>
