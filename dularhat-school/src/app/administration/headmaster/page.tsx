...
export default function HeadmasterPage() {
  ...
  const sectionLinks = [
    { label: language === "bn" ? "প্রশাসন" : "Administration", href: "/administration" },
    { label: language === "bn" ? "প্রধান শিক্ষকের বাণী" : "Headmaster's Message", href: "/administration/headmaster", active: true },
    { label: language === "bn" ? "ম্যানেজিং কমিটি" : "Managing Committee", href: "/administration/committee" },
  ];
